...
function CyclingAreaPage({expiryTimestamp}) {
    ...
    const latestTotalSecondsRef2 = useRef(totalSeconds);

    const intervalCounter = useRef(10);

    const intervalDurations = {"Leicht": 1, "Mittel": 2, "Schwer": 3, "Alternative+": 4};
    const soonIntervalDurations = {"Leicht": 1, "Mittel": 4, "Schwer": 6, "Alternative+": 8};
    const cooldownDurations = {"Leicht": 1, "Mittel": 8, "Schwer": 12, "Alternative+": 32};
    ...
    const setSoonIntervalStyle = useCallback(() => {
        ...
        document.querySelector("#rpm").textContent = "60RPM"
    ...
    const resetSoonIntervalStyle = useCallback(() => {
        ...
        document.querySelector("#rpm").textContent = "40RPM"
    ...
    const setIntervalStyle = useCallback(() => {
        ...
        document.querySelector("#rpm").textContent = "100RPM"
    ...
    const warmup = useCallback(() => {
        document.querySelector("#effort").textContent = " Aufwärm Phase"
        setCooldownStyle()
    ...
    useEffect(() => {
        ...
        const kurbelRotation = setInterval(() => {
            ...
            rotation.current += increase.current
            kurbel.style.transform = `rotate(${rotation.current}deg)`;
        });

        return () => clearInterval(kurbelRotation);
    }, [cooldownDuration, countdown, intervalDuration, resetIntervalStyle, resetSoonIntervalStyle, setCooldownStyle, setIntervalStyle, setSoonIntervalStyle, soonIntervalDuration, totalSeconds]);
    ...
    return (
        <div style={{textAlign: 'center', color: "black"}}>
            ...
            <Button variant="contained" onClick={resume}>Start</Button>
        ...
        <div id='content'>
            ...
            <div className="bikerow">
                <div className="Effortboxes">
                    ...
                    <div id="rpm" className="rpm">Phasen</div>
                ...
                <div className="kurbel-container">
                    <svg    viewBox="0 0 204.54829 204.7681" version="1.1" xmlns="http://www.w3.org/2000/svg" id="kurbel">
